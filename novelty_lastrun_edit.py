...
filename_scene_fam = _thisDir + os.sep + u'data/%s_%s_scene_fam_%s' % (expInfo['participant'], expName, expInfo['date'])
filename_training = _thisDir + os.sep + u'data/%s_%s_training_%s' % (expInfo['participant'], expName, expInfo['date'])
filename_test = _thisDir + os.sep + u'data/%s_%s_test_%s' % (expInfo['participant'], expName, expInfo['date'])
...
a_old = ss.binom.rvs(1, 0.8, size=60)  # worth 100 points if 1 and 0 if 0
b_old = np.fabs(np.ones(60) - a_old)  # worth 100 points if 1 and 0 if 0
a_new = ss.binom.rvs(1, 0.8, size=60)  # worth 100 points if 1 and 0 if 0
b_new = np.fabs(np.ones(60) - a_new)  # worth 100 points if 1 and 0 if 0
c_old = ss.binom.rvs(1, 0.7, size=60)  # worth 100 points if 1 and 0 if 0
d_old = np.fabs(np.ones(60) - c_old)  # worth 100 points if 1 and 0 if 0
c_new = ss.binom.rvs(1, 0.7, size=60)  # worth 100 points if 1 and 0 if 0
...
points_txt_str = u"You've earned " + str(points) + " points!"
if not crit:
    points_txt_str += u"\n Thank you for participating in the experiment. \n Please press 'space' to exit. "
